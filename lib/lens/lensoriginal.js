		...
		a.Prototype = function() {
			this.render = function() {
				r.prototype.render.call(this), this.content.appendChild(i(".back-button", {
					html: '<a class="back-button" href="./" title="Back"><img alt="" src="/ojs/public/journals/1/Favicon_35x35.png"></a>'
				}));
				var t = this.node,
		...
		i.Prototype = function() {
			...
			this.test = function(t, e) {
				...
				var e = t.xmlDoc.querySelector("article"),
					...
					i = n.querySelectorAll("subject"),					
					s = n.querySelectorAll("kwd-group"),					
					a = n.querySelector("pub");
					console.log(i);
					console.log(n);
					console.log(a);
